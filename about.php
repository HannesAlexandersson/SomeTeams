...
<main>
    <div class="container">
        <div class="about">
            ...
            <span class="hidden">Dont forget that there are <?= getTeamCount($teams) ?> teams in Hans array! <a href="cityValues.php">Here</a> are some data from that array only for you! </span>
        </div>
    </div>
</main>
